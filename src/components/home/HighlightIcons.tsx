...
export function PhoneIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className} aria-hidden="true">
      ...
      <motion.circle
        cx="14" cy="21" r="1.5" fill="currentColor"
        animate={{ r: [1.5, 2, 1.5], opacity: [0.4, 1, 0.4] }}
  ...
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className} aria-hidden="true">
      ...
      >
        ...
        <motion.circle
          cx="14" cy="5.5" r="1.5" fill="currentColor"
          animate={{ r: [1.5, 2, 1.5], opacity: [0.5, 1, 0.5] }}
...
export function RupeeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className} aria-hidden="true">
      <motion.circle
        cx="14" cy="14" r="10" stroke="currentColor" strokeWidth="1.5"
        animate={{ scale: [1, 1.05, 1] }}
        transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
        style={{ transformOrigin: '14px 14px' }}
      />
      <motion.circle
        cx="14" cy="14" r="12" stroke="currentColor" strokeWidth="0.5"
...
export function ChartIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className} aria-hidden="true">
      <rect x="10" y="10" width="4" height="10" rx="0.75" fill="currentColor" opacity="0.4" />
      <motion.rect
        x="10" y="10" width="4" height="10" rx="0.75" fill="currentColor"
        animate={{ opacity: [0.3, 1, 0.3] }}
        transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut', delay: 0 }}
      />
      <rect x="16" y="6" width="4" height="14" rx="0.75" fill="currentColor" opacity="0.4" />
      <motion.rect
        x="16" y="6" width="4" height="14" rx="0.75" fill="currentColor"
        animate={{ opacity: [0.3, 1, 0.3] }}
        transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut', delay: 0.3 }}
      />
      <rect x="22" y="8" width="4" height="12" rx="0.75" fill="currentColor" opacity="0.4" />
      <motion.rect
        x="22" y="8" width="4" height="12" rx="0.75" fill="currentColor"
        animate={{ opacity: [0.3, 1, 0.3] }}
...
export function DevicesIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 28 28" fill="none" className={className} aria-hidden="true">
      ...
      <motion.rect
        x="4" y="7" width="8" height="11" rx="0.5" fill="currentColor"
        animate={{ opacity: [0.08, 0.2, 0.08] }}
        transition={{ duration: 3, repeat: Infinity, ease: 'easeInOut' }}
      />
      <rect x="15" y="3" width="10" height="22" rx="1.5" stroke="currentColor" strokeWidth="1.5" />
      <motion.rect
        x="16" y="5" width="8" height="15" rx="0.5" fill="currentColor"
        animate={{ opacity: [0.08, 0.2, 0.08] }}

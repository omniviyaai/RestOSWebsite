        ...
        <div className="max-w-xl mx-auto px-4 pt-28 pb-24">
          ...
          <div className="text-center">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full sm:w-auto sm:inline-flex px-8 py-4 rounded-xl bg-[#25D366] text-white font-display font-semibold text-base hover:bg-[#22c55e] active:scale-[0.98] transition-all duration-150 min-h-[52px]"
            >

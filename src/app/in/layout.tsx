...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      url: 'https://omniviya.in',
      name: 'Omniviya',
      description: 'Omniviya is restaurant management software for Indian restaurants — QR code ordering, kitchen display system, UPI payments, and real-time analytics.',
    ...
    },
    {
      ...
      knowsAbout: ['Restaurant technology', 'Restaurant management software', 'QR ordering', 'Kitchen display systems', 'UPI payments'],
    },
  ],
}
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    site: '@omniviya',
    title: 'Omniviya — Restaurant Management Software India',
    description: 'QR ordering, kitchen display, UPI payments, and real-time analytics for Indian restaurants. No POS hardware. 0% platform fee.',
    images: ['/og-image.png'],
  },
  other: {
    'geo.region': 'IN',
